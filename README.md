...
```
curl -fsSL "https://github.com/elrnv/.tmux/raw/refs/heads/master/install.sh#$(date +%s)" | bash
```

**Manual installation in `~`**
```
$ cd
$ git clone --single-branch https://github.com/elrnv/.tmux.git
...
```
$ git clone --single-branch https://github.com/elrnv/.tmux.git "/path/to/oh-my-tmux"
